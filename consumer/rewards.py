...
def activeRewards(request):
	...
	return basic_success({"earning":result['total_earning'] ,"total_balance":result['total_balance'] ,"total_redeemed":result['total_redeemed'] ,   "redeemed":result['history']['redeemed_offers'] , "earning_list":result['history']['earnings'] , "active_rewards":result1})
